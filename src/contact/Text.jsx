...
const Text = () => {
    ...
    return (
        ...
        <div id="text" className="flex w-full h-screen z-40 absolute top-full items-center justify-center">
            <h1 className="title 2xl:text-9xl xl:text-9xl lg:text-9xl md:text-6xl sm:text-4xl text-3xl underline"><a href="mailto:contact@trofix.me">contact@trofix.me</a></h1>
            <div className="arrow">
